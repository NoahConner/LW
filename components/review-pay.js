    ...
    return(
        <View style={{padding:20}}>
            <View style={styles.flexRow}>
                ...
                <Text style={{fontSize:RFPercentage(2.8),fontFamily:'Gilroy-Bold',marginTop:0,color:'#000',marginLeft:20}}>Review and Confirm</Text>
            </View>
            ...
            <View style={{alignItems: 'flex-end',justifyContent: 'space-between',flexDirection: 'row',marginBottom:40,marginTop:0}}>
                ...
                <View style={{alignItems: 'flex-end',}}>
                    ...
                    <Text style={{marginTop:5,fontSize:RFPercentage(3.5),color:'#000',fontFamily:'Gilroy-Bold'}}>${parseInt(amount)+1.25}</Text>
                </View>
            </View>
            ...
            <View>
                ...
                <Button
                    ...
                    titleStyle={{fontSize:RFPercentage(2.5),color:'#1E3865',fontFamily:'Gilroy-Bold'}}
